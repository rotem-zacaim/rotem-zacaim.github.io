...
const I18N = {
    en: {
        ...
        heroLede: "Information security analyst combining AI, automation, and infrastructure to build practical solutions for cybersecurity and intelligent systems.",
        ...
        llmAccessTitle: "LLM Access",
        llmAccessIntro: "Request controlled public access to the LLM interface. Rotem reviews each request before access opens, and Maya sends the link by WhatsApp only after approval.",
        ...
        experienceIntro: "Hands-on work across government-scale security operations, technical support, infrastructure, automation, and structured operations.",
        ...
        roleThreeTitle: "Israel Police Intelligence Unit",
        roleThreeCopy: "Service in an intelligence unit with structured work, reporting, and procedure-based operations.",
        roleFourTitle: "Logistics and inventory operations",
        roleFourCopy: "IDF ERP/SAP inventory and logistics work completed with excellence.",
        ...
        contactCopy: "Reach me by email or LinkedIn about projects, roles, collaborations, or technical questions.",
    ...
    he: {
        ...
        heroLede: "אנליסט אבטחת מידע שמשלב AI, אוטומציה ותשתיות כדי לבנות פתרונות פרקטיים לעולמות סייבר ומערכות חכמות.",
        ...
        llmAccessTitle: "גישה ל-LLM",
        llmAccessIntro: "בקשת הרשמה לשימוש ציבורי מבוקר בממשק ה-LLM. רותם בודק כל בקשה לפני פתיחת גישה, ומאיה שולחת קישור רק לאחר אישור.",
        ...
        experienceIntro: "עבודה מעשית בתפעול אבטחת מידע בהיקף ממשלתי, תמיכה טכנית, תשתיות, אוטומציה ותפעול מסודר.",
        ...
        roleThreeTitle: "יחידת מודיעין - משטרת ישראל",
        roleThreeCopy: "שירות ביחידת מודיעין עם עבודה מסודרת, דיווח ותפעול לפי נהלים.",
        roleFourTitle: "לוגיסטיקה וניהול מלאי",
        roleFourCopy: "עבודה צבאית עם ERP/SAP לניהול מלאי ולוגיסטיקה שהסתיימה בהצטיינות.",
        ...
        contactTitle: "מוזמנים ליצור קשר",
        contactCopy: "אפשר לפנות אליי במייל או בלינקדאין לגבי פרויקטים, תפקידים, שיתופי פעולה או שאלות מקצועיות.",
...
const CAREER_TIMELINE = [
    ...
    },
    {
        period: "2020-2021",
        title: {
            he: "יחידת מודיעין - משטרת ישראל",
            en: "Israel Police Intelligence Unit",
        },
        summary: {
            he: "שירות ביחידת מודיעין עם עבודה מסודרת, דיווח ותפעול לפי נהלים.",
            en: "Service in an intelligence unit with structured work, reporting, and procedure-based operations.",
        },
        signal: "Intelligence / Reporting",
        tools: ["reporting", "procedures", "structured operations"],
    },
    {
        period: "2014-2017",
        title: {
...
const SKILL_GROUPS = [
    {
        label: "Cyber",
        title: { he: "אבטחת מידע וכלי אבטחה", en: "Security operations and security tooling" },
        summary: {
            he: "John Bryce Cyber Defender, 650 academic hours, לצד ניסיון עבודה עם SIEM ומוצרי אבטחה ארגוניים.",
            en: "John Bryce Cyber Defender, 650 academic hours, alongside hands-on SIEM and enterprise security product work.",
        },
