...
const I18N = {
    en: {
        ...
        heroLede: "Cyber security operations, infrastructure troubleshooting, AI agents, and practical automation tools for real-world systems.",
        ...
        previewTitle: "I turn noisy infrastructure and security work into clear operating systems.",
        previewCopy: "From SIEM investigations and WAF issues to AI-powered agents, I build tools that reduce noise, speed up response, and keep control visible.",
    ...
    he: {
        ...
        heroLede: "אבטחת מידע תפעולית, תחקור תשתיות, סוכני AI וכלי אוטומציה פרקטיים למערכות אמיתיות.",
        ...
        previewTitle: "אני הופך עבודת תשתיות ואבטחה רועשת למערכות תפעול ברורות.",
        previewCopy: "מתחקורי SIEM ובעיות WAF ועד סוכני AI, אני בונה כלים שמורידים רעש, מקצרים תגובה ושומרים שליטה גלויה.",
